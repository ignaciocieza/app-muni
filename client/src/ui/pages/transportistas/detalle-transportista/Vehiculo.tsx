...
export default function Vehiculo({currentRegistro, styleValue, borderStyle}:{currentRegistro:any, styleValue:any, borderStyle:string}){
    const classes=useStyle();
    return(<div className={classes.contentGrid} style={{ width: styleValue }}>
        <span
          style={{
            gridColumn: "1/10",
            gridRow: 1,
